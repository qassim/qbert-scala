...
class Weather extends Plugin {
  ...
  case class Bounds(northeast: Northeast, southwest: Northeast)
  case class Geometry(bounds: Bounds, location: Northeast, location_type: String, viewport: Bounds)
  ...
  case class Currently(time: Double, summary: String, icon: String, nearestStormDistance: Double, nearestStormBearing: Double, precipIntensity: Double, precipProbability: Double, temperature: Double,
  ...
  case class Minutely(summary: String, icon: String, data: List[Data])
